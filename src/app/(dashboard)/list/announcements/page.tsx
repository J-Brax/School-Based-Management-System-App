...
const AnnouncementListPage = async ({
  ...
  // Await searchParams Promise and handle possible array values in Next.js 15
  const params = await searchParams;
  const page = typeof params.page === 'string' ? params.page : params.page?.[0];
  const queryParams: { [key: string]: string | undefined } = {};
  
  // Copy other params excluding page, handling possible array values
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-lamaYellow" aria-label="Filter announcements">
